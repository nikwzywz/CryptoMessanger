# UI Managers - Принцип разделения ответственности

## 🏗️ Архитектурная концепция

CryptoMessenger использует **двухпанельную архитектуру** с четким разделением ответственности между менеджерами UI областей.

## 📋 ContactListManager (contact-ui-manager-v4.js)

**ЗОНА ОТВЕТСТВЕННОСТИ:** Левая панель - список контактов
