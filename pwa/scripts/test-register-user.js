...
/**
 * Тестовый скрипт для регистрации одного пользователя
 * Проверяет, что функция registerPublicKey работает корректно
 */
...
async function testRegisterUser() {
    try {
        ...
        console.log(`   PrivateKeyForEncode: ${privateKeyForEncode}`);
        ...
        const gas = limitGas(estimatedGas);
        
        const gasPrice = getOptimalGasPrice();
